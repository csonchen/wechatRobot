...
async function getWeather() {
  ...
  let res = await superagent(url, 'GET')
  let $ = cheerio.load(res.text)
  ...
  let obj = {
    ...
    todayWeather: todayInfo.Day + ":" + todayInfo.WeatherText + '<br>'
      + '温度：' +  todayInfo.Temp + '<br>' + todayInfo.Wind + todayInfo.WindLevel
      + '<br>' + '空气：' + todayInfo.PollutionLevel + '<br>' 
  }
  return obj
}
